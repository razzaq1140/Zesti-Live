...
class CustomTextFormField extends StatelessWidget {
  ...
  final ValidationType? validationType;
    ...
    final TextEditingController? passwordController; // Add passwordController
  ...
  const CustomTextFormField({
    ...
    this.validationType,
       ...
       this.validator,
    this.passwordController,  // Pass passwordController for password matching
  ...
  String? _validateInput(String? value) {
    switch (validationType) {
      ...
      case ValidationType.title:
        ...
        break;
         case ValidationType.passwordConfirmation: // Check for Confirm Password
...
enum ValidationType {
  ...
  description,
  title,
    passwordConfirmation,  // Added to handle Confirm Password validation
