...
class ScreenShotContent extends StatefulWidget {
  const ScreenShotContent({super.key});

  @override
  ScreenShotContentState createState() => ScreenShotContentState();
}

class ScreenShotContentState extends State<ScreenShotContent> {
