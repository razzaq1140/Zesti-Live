...
class ProfileBottomSheet extends StatelessWidget {
  final int index;
  const ProfileBottomSheet({super.key, required this.index});
    ...
    return Stack(
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: topFans[index].tags.map((tag) {
                  return buildTagItem(
                    context: context,
              ...
              Row(
                ...
                children: [
                  _buildStatColumn(context, topFans[index].fans, 'Fans', null),
                  _buildStatColumn(
                      context, topFans[index].following, 'Following', null),
                  _buildStatColumn(context, topFans[index].zircon, 'Zircon',
                      AppIcons.zircon),
                  _buildStatColumn(
                      context, topFans[index].ruby, 'Ruby', AppIcons.ruby),
                ],
              ),
              const SizedBox(
                height: 12,
        ...
        Positioned(
          ...
          child: CircleAvatar(
            radius: 40,
            backgroundImage: NetworkImage(topFans[index].avatarUrl),
