...
class UserViewCommentPage extends StatefulWidget {
  const UserViewCommentPage({super.key});

  @override
  State<UserViewCommentPage> createState() => _UserViewCommentPageState();
}

class _UserViewCommentPageState extends State<UserViewCommentPage> {
      ...
      Expanded(
        child: Row(
          children: [
            ...
            // Fixed image on the right side, aligned at the bottom
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: Center(
                    child: Padding(
                      padding: const EdgeInsets.only(right: 16.0, top: 120),
                      child: Image.asset(
                        AppImages.magic, // Replace with actual image URL
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
