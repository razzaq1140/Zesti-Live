...
class GamerViewPage extends StatefulWidget {
  final Map<String, String>? selectedGame;

  const GamerViewPage({Key? key, this.selectedGame}) : super(key: key);

  @override
  State<GamerViewPage> createState() => _GamerViewPageState();
}

class _GamerViewPageState extends State<GamerViewPage> {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                        ...
                        child: AbsorbPointer(
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText:
                                  widget.selectedGame?['name'] ?? 'Categories',
                              prefixIcon: Padding(
                                padding:
                                    ...
                                    Expanded(
                                      child: Text(
                                        widget.selectedGame?['name'] ??
                                            'Categories',
                                        style: TextStyle(
                                          color: widget.selectedGame == null
                ...
                InkWell(
                  onTap: () {
                    context.pushNamed(AppRoute.streamerPage);
                  },
                  child: Align(
                ...
                Padding(
                  ...
                  child: Text(
                    "You are now recording your screen, please switch to a game",
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Spacer(), // This will push the last icon to the right
