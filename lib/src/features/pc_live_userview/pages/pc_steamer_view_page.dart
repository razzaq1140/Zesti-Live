...
class PcSteamerViewPage extends StatefulWidget {
  final Map<String, String>? selectedGame;

  const PcSteamerViewPage({Key? key, this.selectedGame}) : super(key: key);

  @override
  State<PcSteamerViewPage> createState() => _PcSteamerViewPageState();
}

class _PcSteamerViewPageState extends State<PcSteamerViewPage> {
  ...
  List<Message> messages = [
    ...
    Message(
      text: "Ankush joineeeed the LIVE",
      isSystem: true,
      imageUrl:
          "https://plus.unsplash.com/premium_photo-1682089892133-556bde898f2c?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8aW5kaWFuJTIwYm95fGVufDB8fDB8fHww", // replace with actual URL
    ),
                              ...
                              : GestureDetector(
                                  onTap: () {
                                    if (index == 0) {
                                      ...
                                      // context.pop();
                                      context
                                          .pushNamed(AppRoute.mobileLivePage);
                                      // Add your specific functionality here
                                    }
                                  },
